	...
	if (self != nil) {
		...
		switch (subType) {
			case kObjectSubType_BlueKey:
				image = [[[pss imageForKey:@"item_keyB.png"] imageCopy] retain];
				break;

			case kObjectSubType_RedKey:
				image = [[[pss imageForKey:@"item_keyR.png"] imageCopy] retain];
				break;
			
			case kObjectSubType_GreenKey:
				image = [[[pss imageForKey:@"item_keyG.png"] imageCopy] retain];
				break;
				
			case kObjectSubType_YellowKey:
				image = [[[pss imageForKey:@"item_key.png"] imageCopy] retain];
				break;
