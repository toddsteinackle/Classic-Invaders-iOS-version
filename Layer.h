...
@interface Layer : NSObject {
	...
	TexturedColoredQuad *tileImages;					// Array of TexturedColoredQuads used to store tile image information for this layer
}
...
// Adds the provided ImageDetails->TexturedColoredQuad information to the tilesImages array
// adjusted so that the tile will render in the correct place
- (void)addTileImageAt:(CGPoint)aPoint imageDetails:(ImageDetails*)aImageDetails;

// Returns a TexturedColoredQuad for the tile image at the specified location.  This can then
// be added to the ImageRenderManagers render queue for rendering.
